...
import 'package:yarucinnamon/src/utils/colors.dart' as yarucinnamon;
import 'package:yarucinnamon/src/utils/text_theme.dart';

part 'text_theme.dart';

final MaterialColor _primarySwatchColor =
    MaterialColor(yarucinnamon.Colors.orange.value, {
  50: Color(0xFFFDEEE9),
  100: Color(0xFFFBDDD2),
  200: Color(0xFFF6BBA6),
  300: Color(0xFFF29879),
  400: Color(0xFFED764D),
  500: Color(yarucinnamon.Colors.orange.value),
...
final _lightColorScheme = ColorScheme.fromSwatch(
  ...
  primaryColorDark: yarucinnamon.Colors.coolGrey,
  accentColor: yarucinnamon.Colors.lightAubergine,
  cardColor: Colors.white,
  backgroundColor: yarucinnamon.Colors.porcelain,
  errorColor: yarucinnamon.Colors.red,
...
final _darkColorScheme = ColorScheme.fromSwatch(
  ...
  primaryColorDark: yarucinnamon.Colors.coolGrey,
  accentColor: yarucinnamon.Colors.lightAubergine,
  cardColor: yarucinnamon.Colors.coolGrey,
  backgroundColor: yarucinnamon.Colors.coolGrey,
  errorColor: yarucinnamon.Colors.red,
...
final lightTheme = ThemeData(
  ...
  bottomNavigationBarTheme: BottomNavigationBarThemeData(
    ...
    unselectedItemColor: yarucinnamon.Colors.coolGrey,
  ),
);
...
// Special casing some widgets to get the desired Yaru Cinnamon look
// Buttons
...
final _outlinedButtonThemeData = OutlinedButtonThemeData(
  ...
  primary: yarucinnamon.Colors.textGrey,
));
...
Color _getElevatedButtonColorLight(Set<MaterialState> states) {
  ...
  if (states.any(interactiveStates.contains)) {
    return yarucinnamon.Colors.green;
  } else if (states.any(disabledStates.contains)) {
    return yarucinnamon.Colors.warmGrey;
  }
  return yarucinnamon.Colors.green;
}
...
Color _getElevatedButtonColorDark(Set<MaterialState> states) {
  ...
  if (states.any(interactiveStates.contains)) {
    ...
    return yarucinnamon.Colors.disabledGreyDark;
  }
  return yarucinnamon.Colors.green;
}
...
Color _getSwitchThumbColorDark(Set<MaterialState> states) {
  if (states.contains(MaterialState.disabled)) {
    ...
    if (states.contains(MaterialState.selected)) {
      return yarucinnamon.Colors.lightAubergine;
    } else {
      return yarucinnamon.Colors.warmGrey;
    }
  }
...
Color _getSwitchTrackColorDark(Set<MaterialState> states) {
  if (states.contains(MaterialState.disabled)) {
    return yarucinnamon.Colors.disabledGreyDark.withAlpha(120);
  } else {
    if (states.contains(MaterialState.selected)) {
      return yarucinnamon.Colors.lightAubergine.withAlpha(160);
    } else {
      return yarucinnamon.Colors.warmGrey.withAlpha(80);
    }
  }
}
...
Color _getSwitchThumbColorLight(Set<MaterialState> states) {
  if (states.contains(MaterialState.disabled)) {
    return yarucinnamon.Colors.warmGrey.shade200;
  } else {
    if (states.contains(MaterialState.selected)) {
      return yarucinnamon.Colors.lightAubergine;
    } else {
...
Color _getSwitchTrackColorLight(Set<MaterialState> states) {
  if (states.contains(MaterialState.disabled)) {
    ...
    if (states.contains(MaterialState.selected)) {
      return yarucinnamon.Colors.lightAubergine.withAlpha(180);
    } else {
      return yarucinnamon.Colors.warmGrey.shade300;
    }
  }
}
...
final _appBarLightTheme = AppBarTheme(
  brightness: Brightness.light,
  color: yarucinnamon.Colors.porcelain,
  textTheme: textTheme.copyWith(
    headline6: textTheme.headline6!.copyWith(
      color: yarucinnamon.Colors.coolGrey,
      fontSize: 20,
      fontWeight: FontWeight.w500,
    ),
  ),
  iconTheme: IconThemeData(color: yarucinnamon.Colors.coolGrey),
  actionsIconTheme: IconThemeData(color: yarucinnamon.Colors.coolGrey),
);

final _appBarDarkTheme = AppBarTheme(
  brightness: Brightness.dark,
  color: yarucinnamon.Colors.inkstone,
);
